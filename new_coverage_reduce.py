...
print('HERE')
# remove test file name from list of entities mapped to each test
# for test_name, entities_list in data_file_dict.items():
#     #print(type(entities_list))
#     for entity in entities_list:
#         test_file_name = 'tests'
#         if test_file_name in entity:
#             print(entity)
#             data_file_dict[test_name].remove(entity)
